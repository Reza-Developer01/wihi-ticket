...
const ReportsBannerTop = ({ data, isUserView }) => {
  ...
  return (
    <div className={`reports__banner ${isUserView ? "!h-auto" : null} flex items-center justify-between`}>
      <div className="flex flex-col">
        ...
        <div className="flex flex-col gap-y-[5px]">
          ...
          <p
            className={`reports__text-gradient font-extrabold ${
              isUserView ? "text-xs w-[218px]" : "text-lg/[25.2px]"
            } tracking-[-0.12px]`}
          >
