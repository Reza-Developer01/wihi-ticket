...
const MessageInput = ({ requestStatus, ticketNumber, id, getRequest }) => {
      ...
      <div className="flex items-center justify-center w-full h-full">
        {requestStatus === "closed" && (
          <p
            ...
            className="text-center text-[#FF0000] leading-[22.4px] font-semibold tracking-[-0.12px] cursor-pointer"
          >
            درخواست بسته شده
          </p>
        )}
        ...
        {openCancelModal && (
          <Modal>
            ...
            >
              <p className="pt-2.5 pl-2.5 pr-2">
                {getRequest.comment_cancelled}
              </p>
            </div>
